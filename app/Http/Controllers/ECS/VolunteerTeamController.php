...
class VolunteerTeamController extends Controller
{
    ...
    const TEAMS = [
        1 => ['center_id' => 1, 'chi_name' => '耆樂大使', 'eng_name' => 'xxx', 'create_date' => '2020-01-31', 'in_charge' => '同事A', 'status' => 'A'],
        2 => ['center_id' => 1, 'chi_name' => '智友伴',  'eng_name' => 'yyy', 'create_date' => '2020-01-30', 'in_charge' => '同事B', 'status' => 'A'],
        3 => ['center_id' => 1, 'chi_name' => '老友記小組',  'eng_name' => 'zzz', 'create_date' => '2020-01-25', 'in_charge' => '同事C', 'status' => 'D'],
    ];
    const STATUSES = [
        'A' => '有效', 'I' => '無效', 'D' => '已解散'
    ];
