...
class CarerController extends Controller
{
    ...
    const FROM4_CB = [
        '接收護老資訊刊物 (給護老者)', '義工探訪', '護老者訓練', '復康器材借用 (如輪椅、助行架)', '電話慰問', '外傭訓練', '購物優惠 (如尿片、奶粉)',
        '暫托服務', '善終服務', '社交活動 (如旅行、茶聚)', '短暫到戶/中心看顧', '護送服務', '其他'
    ];

    const FORM5_CB_1 = [
        '工作收入', '高齡津貼', '長者生活津貼/高額長者生活津貼', '退休金/長俸', '儲蓄', '傷殘/高額傷殘津貼', '子女/親屬供養', '綜援', '其他'
    ];
    ...
    const FORM5_CB_4 = [
        '心臟病','柏金遜症','腎病','關節炎','高血壓','認知障礙症','抑鬱症','骨質疏鬆症','糖尿病','失聰/部份失聰','氣管/肺病','中風','癌症', '眼疾', '其他'
    ];

    const FORM5_CB_5 = [
        '行動自如', '雨傘/枴杖', '四腳叉/助行架', '輪椅', '長期臥床'
    ];
