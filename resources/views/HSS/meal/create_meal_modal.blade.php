<!-- Modal -->
<div class="modal fade" id="create-meal-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="mb-3">
                        ...
                        @foreach(['一', '二', '三', '四', '五', '六', '日'] as $d)
                            <div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input delivery-time" type="checkbox" id="mon-am" value="mon_am">
                                    <label class="form-check-label" for="mon-am">星期{{ $d }}中午</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input delivery-time" type="checkbox" id="mon-pm" value="mon_pm">
                    ...
                    <div class="mb-3">
                        ...
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="meal-type-1" value="">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="avoid-food">
                    </div>
                    <div class="mb-3">
