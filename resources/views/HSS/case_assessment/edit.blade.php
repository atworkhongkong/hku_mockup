        ...
        <div class="content__wrapper">
            ...
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <a class="nav-item nav-link" id="nav-tab-13" data-toggle="tab" href="#nav-page-13" role="tab" aria-controls="nav-page-13" aria-selected="false">
                        計劃
                    </a>
                </div>
            </nav>
