                ...
                <table class="table table-bordered" style="font-size:.9rem;">
                    <thead>
                        <tr class="text-center">
                            <th scope="col" rowspan="2">GDS</th>
                            <th scope="col" rowspan="2">No. of cases with start of ICP b/f from last month</th>
                            <th scope="col" colspan="4">New case</th>
                            <th scope="col" colspan="4">Closed case</th>
                        </tr>
                        <tr class="text-center">
                            <th>New HA cases</th>
