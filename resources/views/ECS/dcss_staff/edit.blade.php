        ...
        <div class="content__wrapper">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ $staff_details['chi_name'] }}</li>
                </ol>
            </nav>
                ...
                <form>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="input-chi-name" value="{{ $staff_details['chi_name'] }}">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="input-eng-name" class="form-label">英文姓名</label>
                            <input type="text" class="form-control" id="input-eng-name" value="{{ $staff_details['eng_name'] }}">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="input-email" value="{{ $staff_details['email'] }}">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="input-post" value="{{ $staff_details['post'] }}">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="input-report-date" class="form-label">入職日期</label>
                            <input type="date" class="form-control" id="input-report-date" value="{{ $staff_details['report_date'] }}">
                        </div>
                    </div>
